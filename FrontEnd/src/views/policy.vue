<template>
  <div>
    <div style="background: #457992; padding: 30px">
      <h1 style="color: white; text-align: center; font-size: 40px">POLICY</h1>
    </div>
    ...
    >
      <div class="post_type_exist clearfix">
        ...
        <p>
          Your privacy is important to us. It is Trẻ Trâu English Class’ policy
          ...
          <a href="https://ielts.tretrau.vn">https://ielts.tretrau.vn</a>, and other sites we
          own and operate.
        </p>
        <p>
          This policy is effective as of 27 January 2024 and was last updated on
          27 January 2024.
        </p>
        ...
        <ul>
          ...
          <h4>Request deletion of collected data</h4>
          <p>
            If you wish to delete the collected data, you can contact us via
            email: hieptr626@gmail.com, or go to our office at the address: 75
            Hung Vuong, Buon Ma Thuot, Dak Lak
          </p>
        </ul>
        ...
        <h4>Request deletion of collected data</h4>
        <p>
          You can contact us via email: hieptr626@gmail.com, or go to our office
          at the address: 75 Hung Vuong, Buon Ma Thuot, Dak Lak
        </p>
