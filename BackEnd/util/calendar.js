  ...
  try {
    ...
    oldClass.students.forEach(async (student) => {
      const newNotification = new Notification({
        title: "New schedular added",
        type: "create",
        content: `The teacher has just added a new class schedule in ${oldClass.name}`,
        userId: student._id,
    ...
    if (result.classId) {
      ...
      oldClass.students.forEach(async (student) => {
        const newNotification = new Notification({
          ...
          type: "Update",
          content: `The teacher has just updated the class schedule at ${oldClass.name}`,
          userId: student._id,
          metadata: { ClassId: result.classId },
          bannerImg: oldClass.bannerImg,
        });
