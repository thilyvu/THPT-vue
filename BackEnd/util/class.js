  ...
  try {
    ...
    oldClass.students.forEach(async (student) => {
      const newNotification = new Notification({
        ...
        type: "update",
        content: `Teacher ${req.user.name} has just updated the class information`,
        userId: student._id,
    ...
    if (student.role == "teacher") {
      ...
      if (!oldClass.approveMode) {
        ...
        if (!isExisted) {
          ...
          //     title: "Join class",
          //     type: "create",
          //     content: `Student ${req.user.name} has just joined ${oldClass.name}`,
          //     userId: student._id,
          //     metadata: { ClassId: req.params.id },
          //     bannerImg: oldClass.bannerImg,
          //   });
          ...
          const newNotification = new Notification({
            title: "Join class",
            type: "create",
            content: `Student ${req.user.name} has just joined ${oldClass.name}'s class`,
        ...
        if (!isExisted) {
          ...
          const newNotification = new Notification({
            title: "Request to join the class",
            type: "create",
            content: `Student ${req.user.name} has just sent a request to join ${oldClass.name}'s class`,
            userId: oldClass.createBy,
            metadata: { ClassId: req.params.id },
            bannerImg: oldClass.bannerImg,
          });
      ...
      if (!student) {
        ...
        if (student.role == "teacher") {
          ...
          if (!isExisted) {
            ...
            //   const newNotification = new Notification({
            //     title: "Class information Update",
            //     type: "update",
            //     content: `Student ${student.name} has just been approved ${oldClass.name}`,
            //     userId: stu._id,
            ...
            const newNotification = new Notification({
              title: "Browse class attendance requests",
              type: "update",
              content: `Congratulations you have just been approved to ${oldClass.name}`,
              userId: student._id,
              metadata: { ClassId: result.classId },
              bannerImg: oldClass.bannerImg,
            });
  ...
  try {
    ...
    if (!student) {
      ...
      if (student.role == "teacher") {
        ...
        //     type: "update",
        //     content: `Student ${student.name} has just been added ${oldClass.name}`,
        //     userId: stu._id,
        //     metadata: { ClassId: result.classId },
        //     bannerImg: oldClass.bannerImg,
        //   });
        ...
        const newNotification = new Notification({
          title: "Add to class",
          type: "update",
          content: `Congratulations you has just been added  ${oldClass.name}`,
          userId: student._id,
          metadata: { ClassId: result.classId },
          bannerImg: oldClass.bannerImg,
        });
    ...
    if (isExisted) {
      ...
      oldClass.students.forEach(async (student) => {
        const newNotification = new Notification({
          title: "Leave class",
          type: "update",
          content: `Student ${req.user.name} has just left ${oldClass.name}`,
          userId: student._id,
          metadata: { ClassId: req.params.id },
          bannerImg: oldClass.bannerImg,
        });
  ...
  try {
    ...
    deleteClass.students.forEach(async (student) => {
      const newNotification = new Notification({
        title: "Delete class",
        type: "delete",
        content: `${deleteClass.name} has just been deleted `,
        userId: student._id,
        metadata: { ClassId: req.params.id },
